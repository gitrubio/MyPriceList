...
class ListModel(val name: String, val total: Double, val productos: List<ProductModel>) {
    ...
    // La propiedad 'productos' es de tipo List<String> y se inicializa con el valor del parámetro 'productos' del constructor

    // Constructor de la clase ListModel
    init {
        // Inicialización adicional del objeto Pedido si es necesario
        // Puedes agregar código aquí para realizar acciones adicionales en la inicialización del objeto
    }
}